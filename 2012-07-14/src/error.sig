...
signature ERRORFORMAT =
	...
	(* assumes that spaces separate words *)

	val formatInteractive : format list -> format list -> format list
...
signature ERROR =
	...
	val mkTYPEAPPLN  : cnstr -> ErrorSignal
	val mkPATH  	 : cnstr -> ErrorSignal
	val mkAPPLNTYPE  : cnstr list -> ErrorSignal
	val mkAPPLNNFUN  : cnstr list -> ErrorSignal
	val mkIMMED 	 : ErrorSignal
	val mkASSUMPTION : int -> ErrorSignal
	val mkREPLLHS 	 : int -> cnstr -> ErrorSignal
	
	val ErrorHandler : ErrorSignal -> unit
    end;
